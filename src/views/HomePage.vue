...
<div class="confluence-page">
  ...
  <main>
    <div class="info_present_container">
      <p
        style="font-size:30px; font-weight:300;padding:15px; color:black;font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;margin-bottom:0px;margin-top:50px;">
        Boundless IntelligentEditor</p>
      <div class="info_present" :class="{ 'no_transition': if_transition }"
        :style="{ transform: `translateX(-${currentSlide * viewImageWidth}px)` }">
    ...
    .info_present_slide {
      ...
      .content_block {
        ...
        img {
          ...
          width: 100%;
          height: 100%;
          /* 修改为 100% 使 img 元素填充整个父元素 */
          object-fit: cover;
          /* 添加 object-fit: cover; 以保持宽高比并裁剪多余部分 */
        }
